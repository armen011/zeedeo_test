...
const Layout = ({ children }: { children: ReactNode }) => {
  return (
    <main className="w-screen h-screen bg-[url('/images/reset_backgroud.png')] bg-no-repeat bg-cover bg-center px-2 sm:px-9 flex justify-center lg:justify-start items-center">
